...
<div class="container">
  ...
  <div id="filter-btn-wrap">
    ...
    <div id="not-corpBtn" v-bind:class="{'not-disp':corpflg}">
      <input id="corp-toggle" type="checkbox" v-model="corpflg" v-on:change="corpToggle()">
      <label for="corp-toggle">
        {{corpTxt}}
      </label>
    </div>
  ...
  <div v-show="!msg" id="list-foot">
    ...
    <div class="dl-wrap">
      ...
      <div>
      <!--<button v-on:click="fileOutput('all')">1ページリスト（pdf）</button>-->
...
export default {
  ...
  methods: {
    ...
    corpToggle:function(){
      if(this.corpflg){
        this.corpTxt='法人プランNG表示';
        this.isFilterling();
      }else{
        this.corpTxt='法人プランNG除外';
        this.corpExclusion();
      }
    },
    //法人プラン不可絞込
